...
main! = |_args| {
	...
	Playwright.uncheck!(page, ".toggle-all")?
	Assert.eq(Playwright.query_count!(page, ".todo-list li.completed")?, 0) ? |e| AllShouldBeActiveAgain(e)
	Assert.eq(Playwright.text_content!(page, ".todo-count")?, "3 items left") ? |e| EverythingShouldBeLeft(e)
